...
namespace Defender {
	/// <summary>
	/// Implements a very resiliant <see cref="IDisposable"/> base, for purely managed types, that's easy and safe to extend.
	/// </summary>
	/// <remarks>
	...
	public abstract class Controlled : IDisposable
