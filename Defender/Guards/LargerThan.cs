...
namespace Defender {
	public static partial class Guard {
		...
		public static void LargerThan<T>(T[] array, String name, Int32 lower) {
		...
		/// <param name="lower">The lower bound.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void LargerThan<T>(Span<T> span, String name, Int32 lower) {
		...
		/// <param name="lower">The lower bound.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void LargerThan<T>(ReadOnlySpan<T> span, String name, Int32 lower) {
			if (span.Length <= lower) {
				throw new ArgumentSizeException(name, $"Argument must contain more elements than the lower bound '{lower}'.");
			}
		}
		...
		/// <param name="lower">The lower bound.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void LargerThan<T>(Memory<T> memory, String name, Int32 lower) {
		...
		/// <param name="lower">The lower bound.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void LargerThan<T>(ReadOnlyMemory<T> memory, String name, Int32 lower) {
			if (memory.Length <= lower) {
				throw new ArgumentSizeException(name, $"Argument must contain more elements than the lower bound '{lower}'.");
			}
		}
		...
		/// <param name="lower">The lower bound.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void LargerThan<C>(C collection, String name, Int32 lower) where C : ICollection {
		...
		/// <param name="lower">The lower bound.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void LargerThan<C, T>(C collection, String name, Int32 lower) where C : ICollection<T> {
			if (collection.Count <= lower) {
				throw new ArgumentSizeException(name, $"Argument must contain more elements than the lower bound '{lower}'.");
			}
		}
